...
<body>
    <header class="site-header">
        ...
        <nav class="main-menu">
            ...
            <li><a href="recent_sales.php" class="<?php echo ($currentPage === 'recent_sales.php') ? 'active' : ''; ?>">Ultimas ventas</a></li>
            </ul>
        </nav>
        <div class="user-menu">
